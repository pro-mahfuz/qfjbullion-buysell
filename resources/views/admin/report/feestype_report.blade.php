...
<div class="row">
 ...
 common_select2" required="">
                ...
                @if($isSearchAble)
                <div class="row">
                    <div class="col-md-4"><h4>Toatal amount: {{ number_format($total_amount, 2) }}</h4></div>
                    <div class="col-md-4"><h4>Toatal Paid: {{ number_format($total_paid, 2) }}</h4></div>
                    <div class="col-md-4"><h4>Toatal Due: {{ number_format(($total_amount - $total_paid), 2) }}</h4></div>
                </div>
                @endif
