                                ...
                                <div class="row" style="display: flex;align-items: center;">
                                    ...
                                    <div class="col-sm-5 col-md-5 col-12" style="text-align:center; padding: 10px 10px;">
                                        <div class=""
                                            ...
                                            <p style="font-size: 30px; display:contents;"><b>{{ $supplier->full_name }} </b>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-md-5 col-5">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3>DEPOSIT <span class="pull-right">
                                                        {{ number_format($supplier->init_balance + $supplier->deposit_amount, 2) }}
                                                        AED </span></h3>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <h5 class="card-title">Widthdraw <span class="pull-right">2323 Gm</span>
                                                </h5>
                                    ...
                                    <div class="col-sm-2 col-md-2 col-2">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="#" class="btn btn-primary" style="width: 100%;">View
                                                    Details</a>
                                                <a href="#" class="btn btn-primary" style="width: 100%;">View
                                                    Details</a>
                                                <a href="#" class="btn btn-primary" style="width: 100%;">View
                                    ...
                                    <table class="table table-striped table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th
                                                    style="border: 2px solid !important; text-align: center; background-color: #dae6ed !important; font-size:19px;">
                                                    Supplier Name</th>
                                                <th
                                                    style="border: 2px solid !important; text-align: center; background-color: #dae6ed !important; font-size:19px;">
                                                    Initial Amount</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td
                                                    style="border: 2px solid !important; text-align: center;font-size:19px;">
                                                    {{ $supplier->init_balance + $supplier->deposit_amount - $supplier->sell_amount }}
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-12">
                                    <table class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th
                                                    ...
                                                    Balance </th>
                                                <th
                                                    style="border: 2px solid !important; text-align: center; background-color: gold !important; font-size:19px;">
                                                    Gold Unfix </th>
                                                <th
                                                    style="border: 2px solid !important; text-align: center; background-color: gold !important; font-size:19px;">
                                                    Gold Fixed </th>
                                            ...
                                            @if (count($accounts) > 0)
                                                ...
                                                @foreach ($accounts as $row)
                                                    @if ($row->type != 'deposit')
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="border: 2px solid !important; text-align: center; font-size:15px;">
                                                                {{ date('d/M/Y H:i', strtotime($row->data->purchase->created_at)) }}
                                                            </td>
                                                            <td
                                                                style="border: 2px solid !important; text-align: center; font-size:15px;">
                                                            ...
                                                            <td
                                                                style="border: 2px solid !important; text-align: center; font-size:15px;">
                                                                {{ $row->data->type == 'buy' ? '--' : '--' }}</td>
                                                            <td
                                                                style="border: 2px solid !important; text-align: center; font-size:15px;">
                                                                {{ $row->data->type != 'buy' ? $row->data->unfix_subtotal : '--' }}
                                                            </td>
                                                            <td
                                                                style="border: 2px solid !important; text-align: center; font-size:17px;">
                                                    ...
                                                    @else
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="border: 2px solid !important; text-align: center; font-size:15px;">
                                                                {{ date('d/M/Y H:i', strtotime($row->data->created_at)) }}
                                                            </td>
                                                            <td
                                                                style="border: 2px solid !important; text-align: center; font-size:15px;">
                                                            ...
                                                            <td
                                                                style="border: 2px solid !important; text-align: center; font-size:17px;">
                                                                {{ $gold_deposit - $gold_costing }} Gram</td>
                                                        </tr>
                                                    @endif
                                                    <!-- Display Balance -->
                                                @endforeach
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td style="border: 2px solid !important; text-align: right; font-size:19px;"
                                                    colspan="5">TOTAL</td>
                                                <td
                                                    style="border: 2px solid !important; text-align: center; font-size:15px;">
